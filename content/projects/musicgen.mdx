...
description: LSTM Based Music Generation System
repository: momongah/MusicGenerator
date: 2019-12-6
published: true
---

<MidiPlayer playing src="/lstmsong.mid" visualizer="#viz"  className="flex justify-center items-center h-screen"/>

<MidiVisualizer reload id="viz" src="/lstmsong.mid" type="staff" /> 
